...
std::pair<std::string, std::string> FEditor::Resources::RawShaders::GetGrid()
{
...
std::pair<std::string, std::string> FEditor::Resources::RawShaders::GetGizmo()
{
	std::pair<std::string, std::string> source;
...
std::pair<std::string, std::string> FEditor::Resources::RawShaders::GetBillboard()
{
	std::pair<std::string, std::string> source;
