...
void FEditor::Utils::ActorCreationMenu::GenerateActorCreationMenu(FEditorUI::Widgets::Menu::MenuList& p_menuList, OvCore::ECS::Actor* p_parent, std::optional<std::function<void()>> p_onItemClicked)
{
