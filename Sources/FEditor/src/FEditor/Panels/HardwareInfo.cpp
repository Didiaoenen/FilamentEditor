...
FEditor::Panels::HardwareInfo::HardwareInfo
(
	...
	m_hardwareInfo(new OvAnalytics::Hardware::HardwareInfo(m_logFrequency))
{
	...
	CreateWidget<FEditorUI::Widgets::Texts::Text>("Vendor: " + renderer.GetString(GL_VENDOR));
	CreateWidget<FEditorUI::Widgets::Texts::Text>("Hardware: " + renderer.GetString(GL_RENDERER));
	CreateWidget<FEditorUI::Widgets::Texts::Text>("OpenGL Version: " + renderer.GetString(GL_VERSION));
	CreateWidget<FEditorUI::Widgets::Texts::Text>("GLSL Version: " + renderer.GetString(GL_SHADING_LANGUAGE_VERSION));
...
void FEditor::Panels::HardwareInfo::Update(float p_deltaTime)
{
	m_hardwareInfo->Tick();
