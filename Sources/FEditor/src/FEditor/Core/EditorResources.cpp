...
#include "FEditor/Resources/RawTextures.h"
#include "FEditor/Resources/RawShaders.h"

FEditor::Core::EditorResources::EditorResources(const std::string& p_editorAssetsPath)
{
	...
	/* Shaders */
	auto gridSource			= FEditor::Resources::RawShaders::GetGrid();
	auto gizmoSource		= FEditor::Resources::RawShaders::GetGizmo();
	auto billboardSource	= FEditor::Resources::RawShaders::GetBillboard();
...
FEditor::Core::EditorResources::~EditorResources()
{
...
OvRendering::Resources::Texture* FEditor::Core::EditorResources::GetFileIcon(const std::string& p_filename)
{
	using namespace FTools::Utils;
	return GetTexture("Icon_" + PathParser::FileTypeToString(PathParser::GetFileType(p_filename)));
}

OvRendering::Resources::Texture* FEditor::Core::EditorResources::GetTexture(const std::string& p_id)
{
...
OvRendering::Resources::Model* FEditor::Core::EditorResources::GetModel(const std::string& p_id)
{
...
OvRendering::Resources::Shader* FEditor::Core::EditorResources::GetShader(const std::string& p_id)
{
