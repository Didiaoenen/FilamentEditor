...
bool FEditor::Core::GizmoBehaviour::IsSnappedBehaviourEnabled() const
{
...
void FEditor::Core::GizmoBehaviour::StartPicking(OvCore::ECS::Actor& p_target, const OvMaths::FVector3& p_cameraPosition, EGizmoOperation p_operation, EDirection p_direction)
{
	m_target = &p_target;
	m_firstMouse = true;
...
void FEditor::Core::GizmoBehaviour::StopPicking()
{
	m_target = nullptr;
}

OvMaths::FVector3 FEditor::Core::GizmoBehaviour::GetFakeDirection() const
{
	auto result = OvMaths::FVector3();

	switch (m_direction)
	{
	case FEditor::Core::GizmoBehaviour::EDirection::X:
		result = OvMaths::FVector3::Right;
		break;
	case FEditor::Core::GizmoBehaviour::EDirection::Y:
		result = OvMaths::FVector3::Up;
		break;
	case FEditor::Core::GizmoBehaviour::EDirection::Z:
...
OvMaths::FVector3 FEditor::Core::GizmoBehaviour::GetRealDirection(bool p_relative) const
{
	auto result = OvMaths::FVector3();
...
OvMaths::FVector2 FEditor::Core::GizmoBehaviour::GetScreenDirection(const OvMaths::FMatrix4& p_viewMatrix, const OvMaths::FMatrix4& p_projectionMatrix, const OvMaths::FVector2& p_viewSize) const
{
...
void FEditor::Core::GizmoBehaviour::ApplyTranslation(const OvMaths::FMatrix4& p_viewMatrix, const OvMaths::FMatrix4& p_projectionMatrix, const OvMaths::FVector2& p_viewSize) const
{
	...
	{
		translationCoefficient = SnapValue(translationCoefficient, FEditor::Settings::EditorSettings::TranslationSnapUnit);
	}

	m_target->transform.SetWorldPosition(originPosition + GetRealDirection(true) * translationCoefficient);
}

void FEditor::Core::GizmoBehaviour::ApplyRotation(const OvMaths::FMatrix4& p_viewMatrix, const OvMaths::FMatrix4& p_projectionMatrix, const OvMaths::FVector2& p_viewSize) const
{
	...
	if (IsSnappedBehaviourEnabled())
	{
		rotationCoefficient = SnapValue(rotationCoefficient, FEditor::Settings::EditorSettings::RotationSnapUnit);
	}
...
void FEditor::Core::GizmoBehaviour::ApplyScale(const OvMaths::FMatrix4& p_viewMatrix, const OvMaths::FMatrix4& p_projectionMatrix, const OvMaths::FVector2& p_viewSize) const
{
	...
	if (IsSnappedBehaviourEnabled())
	{
		scaleCoefficient = SnapValue(scaleCoefficient, FEditor::Settings::EditorSettings::ScalingSnapUnit);
	}
...
void FEditor::Core::GizmoBehaviour::ApplyOperation(const OvMaths::FMatrix4& p_viewMatrix, const OvMaths::FMatrix4& p_projectionMatrix, const OvMaths::FVector2& p_viewSize)
{
...
void FEditor::Core::GizmoBehaviour::SetCurrentMouse(const OvMaths::FVector2& p_mousePosition)
{
	if (m_firstMouse)
	{
...
bool FEditor::Core::GizmoBehaviour::IsPicking() const
{
	return m_target;
}

FEditor::Core::GizmoBehaviour::EDirection FEditor::Core::GizmoBehaviour::GetDirection() const
{
	return m_direction;
}