...
FEditor::Core::EditorRenderer::EditorRenderer(Context& p_context) : m_context(p_context)
{
...
void FEditor::Core::EditorRenderer::InitMaterials()
{
	/* Default Material */
...
void FEditor::Core::EditorRenderer::PreparePickingMaterial(OvCore::ECS::Actor& p_actor, OvCore::Resources::Material& p_material)
{
...
OvMaths::FMatrix4 FEditor::Core::EditorRenderer::CalculateCameraModelMatrix(OvCore::ECS::Actor& p_actor)
{
...
void FEditor::Core::EditorRenderer::RenderScene(const OvMaths::FVector3& p_cameraPosition, const OvRendering::LowRenderer::Camera& p_camera, const OvRendering::Data::Frustum* p_customFrustum)
{
	/* Render the actors */
...
void FEditor::Core::EditorRenderer::RenderSceneForActorPicking()
{
...
void FEditor::Core::EditorRenderer::RenderUI()
{
	m_context.uiManager->Render();
}

void FEditor::Core::EditorRenderer::RenderCameras()
{
	using namespace OvMaths;
...
void FEditor::Core::EditorRenderer::RenderLights()
{
	using namespace OvMaths;
...
void FEditor::Core::EditorRenderer::RenderGizmo(const OvMaths::FVector3& p_position, const OvMaths::FQuaternion& p_rotation, FEditor::Core::EGizmoOperation p_operation, bool p_pickable, int p_highlightedAxis)
{
	using namespace OvMaths;
	...
	if (!p_pickable)
	{
		...
		switch (p_operation)
		{
		case FEditor::Core::EGizmoOperation::TRANSLATE:
			arrowModel = m_context.editorResources->GetModel("Arrow_Translate");
			break;
		case FEditor::Core::EGizmoOperation::ROTATE:
			arrowModel = m_context.editorResources->GetModel("Arrow_Rotate");
			break;
		case FEditor::Core::EGizmoOperation::SCALE:
...
void FEditor::Core::EditorRenderer::RenderModelToStencil(const OvMaths::FMatrix4& p_worldMatrix, OvRendering::Resources::Model& p_model)
{
...
void FEditor::Core::EditorRenderer::RenderModelOutline(const OvMaths::FMatrix4& p_worldMatrix, OvRendering::Resources::Model& p_model, float p_width)
{
...
void FEditor::Core::EditorRenderer::RenderActorOutlinePass(OvCore::ECS::Actor& p_actor, bool p_toStencil, bool p_isSelected)
{
	...
	if (p_actor.IsActive())
	{
		...
		if (p_isSelected && !p_toStencil)
		{
			...
			if (FEditor::Settings::EditorSettings::ShowLightBounds)
			{
...
void FEditor::Core::EditorRenderer::RenderCameraPerspectiveFrustum(std::pair<uint16_t, uint16_t>& p_size, OvCore::ECS::Components::CCamera& p_camera)
{
...
void FEditor::Core::EditorRenderer::RenderCameraOrthographicFrustum(std::pair<uint16_t, uint16_t>& p_size, OvCore::ECS::Components::CCamera& p_camera)
{
...
void FEditor::Core::EditorRenderer::RenderCameraFrustum(OvCore::ECS::Components::CCamera& p_camera)
{
...
void FEditor::Core::EditorRenderer::RenderActorCollider(OvCore::ECS::Actor & p_actor)
{
...
void FEditor::Core::EditorRenderer::RenderLightBounds(OvCore::ECS::Components::CLight& p_light)
{
	bool depthTestBackup = m_context.renderer->GetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST);
	m_context.renderer->SetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST, false);
...
void FEditor::Core::EditorRenderer::RenderAmbientBoxVolume(OvCore::ECS::Components::CAmbientBoxLight & p_ambientBoxLight)
{
	bool depthTestBackup = m_context.renderer->GetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST);
	m_context.renderer->SetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST, false);
...
void FEditor::Core::EditorRenderer::RenderAmbientSphereVolume(OvCore::ECS::Components::CAmbientSphereLight & p_ambientSphereLight)
{
	bool depthTestBackup = m_context.renderer->GetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST);
	m_context.renderer->SetCapability(OvRendering::Settings::ERenderingCapability::DEPTH_TEST, false);
...
void FEditor::Core::EditorRenderer::RenderBoundingSpheres(OvCore::ECS::Components::CModelRenderer& p_modelRenderer)
{
	using namespace OvCore::ECS::Components;
	using namespace OvPhysics::Entities;
...
void FEditor::Core::EditorRenderer::RenderModelAsset(OvRendering::Resources::Model& p_model)
{
...
void FEditor::Core::EditorRenderer::RenderTextureAsset(OvRendering::Resources::Texture & p_texture)
{
...
void FEditor::Core::EditorRenderer::RenderMaterialAsset(OvCore::Resources::Material & p_material)
{
	FMatrix4 model = OvMaths::FMatrix4::Scaling({ 3.f, 3.f, 3.f });
...
void FEditor::Core::EditorRenderer::RenderGrid(const OvMaths::FVector3& p_viewPos, const OvMaths::FVector3& p_color)
{
...
void FEditor::Core::EditorRenderer::UpdateLights(OvCore::SceneSystem::Scene& p_scene)
{
...
void FEditor::Core::EditorRenderer::UpdateLightsInFrustum(OvCore::SceneSystem::Scene& p_scene, const OvRendering::Data::Frustum& p_frustum)
{
