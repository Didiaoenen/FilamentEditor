...
{
	class ProjectSettings : public FEditorUI::Panels::PanelWindow
	{
	public:
		/**
		* Constructor
		...
		*/
		...
		{
			return std::bind(&FTools::Filesystem::IniFile::Get<T>, &m_projectFile, p_keyName);
		}
		...
		*/
		...
		{
			return std::bind(&FTools::Filesystem::IniFile::Set<T>, &m_projectFile, p_keyName, std::placeholders::_1);
		}

	private:
		FTools::Filesystem::IniFile& m_projectFile;
	};
}