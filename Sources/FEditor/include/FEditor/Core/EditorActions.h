...
#define EDITOR_EXEC(action)					OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>().action
#define EDITOR_BIND(method, ...)			std::bind(&FEditor::Core::EditorActions::method, &OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>(), ##__VA_ARGS__)
#define EDITOR_EVENT(target)				OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>().target
#define EDITOR_CONTEXT(instance)			OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>().GetContext().instance
#define EDITOR_RENDERER()					OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>().GetRenderer()
#define EDITOR_PANEL(type, id)				OvCore::Global::ServiceLocator::Get<FEditor::Core::EditorActions>().GetPanelsManager().GetPanelAs<type>(id)
...
namespace FEditor::Core
{
	...
	*/
	...
	public:
		...
		* @param p_fileType
		*/
		void PropagateFileRenameThroughSavedFilesOfType(const std::string& p_previousName, const std::string& p_newName, FTools::Utils::PathParser::EFileType p_fileType);
		#pragma endregion
	...
	public:
		...
		FTools::Eventing::Event<EEditorMode> EditorModeChangedEvent;
		FTools::Eventing::Event<> PlayEvent;
...
#include "FEditor/Core/EditorActions.inl"