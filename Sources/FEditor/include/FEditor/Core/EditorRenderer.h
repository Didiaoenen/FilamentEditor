...
namespace FEditor::Core { enum class EGizmoOperation; }
namespace FEditor::Panels { class AView; }
...
namespace FEditor::Core
{
	...
	*/
	...
	public:
		...
		*/
		void RenderGizmo(const OvMaths::FVector3& p_position, const OvMaths::FQuaternion& p_rotation, FEditor::Core::EGizmoOperation p_operation, bool p_pickable, int p_highlightedAxis = -1);
