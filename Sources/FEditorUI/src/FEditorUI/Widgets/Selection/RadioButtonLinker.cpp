...
#include "FEditorUI/Widgets/Selection/RadioButtonLinker.h"

FEditorUI::Widgets::Selection::RadioButtonLinker::RadioButtonLinker() : DataWidget<int>(m_selected)
{
}

void FEditorUI::Widgets::Selection::RadioButtonLinker::Link(RadioButton& p_radioButton)
{
...
void FEditorUI::Widgets::Selection::RadioButtonLinker::Unlink(RadioButton& p_radioButton)
{
	auto it = std::find_if(m_radioButtons.begin(), m_radioButtons.end(), [&p_radioButton](std::pair<FTools::Eventing::ListenerID, std::reference_wrapper<RadioButton>>& p_pair)
	{
...
int FEditorUI::Widgets::Selection::RadioButtonLinker::GetSelected() const
{
	return m_selected;
}

void FEditorUI::Widgets::Selection::RadioButtonLinker::_Draw_Impl()
{
	// The RadioButtonLinker is special, it has nothing to display :)
}

void FEditorUI::Widgets::Selection::RadioButtonLinker::OnRadioButtonClicked(int p_radioID)
{
