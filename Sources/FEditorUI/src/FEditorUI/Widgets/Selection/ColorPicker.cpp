...
#include "FEditorUI/Widgets/Selection/ColorPicker.h"

FEditorUI::Widgets::Selection::ColorPicker::ColorPicker(bool p_enableAlpha, const Types::Color & p_defaultColor) :
	DataWidget<Types::Color>(color), enableAlpha(p_enableAlpha), color(p_defaultColor)
{
}

void FEditorUI::Widgets::Selection::ColorPicker::_Draw_Impl()
{
