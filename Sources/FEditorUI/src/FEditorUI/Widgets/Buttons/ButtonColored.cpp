...
#include "FEditorUI/Widgets/Buttons/ButtonColored.h"
#include "FEditorUI/Internal/Converter.h"

FEditorUI::Widgets::Buttons::ButtonColored::ButtonColored(const std::string & p_label, const Types::Color& p_color, const OvMaths::FVector2& p_size, bool p_enableAlpha) :
	label(p_label), color(p_color), size(p_size), enableAlpha(p_enableAlpha)
{
}

void FEditorUI::Widgets::Buttons::ButtonColored::_Draw_Impl()
{
