...
FEditorUI::Panels::PanelWindow::PanelWindow(const std::string& p_name, bool p_opened, const Settings::PanelWindowSettings& p_floatingPanelSettings) :
	name(p_name),
...
void FEditorUI::Panels::PanelWindow::Open()
{
	if (!m_opened)
	{
		m_opened = true;
...
void FEditorUI::Panels::PanelWindow::Close()
{
	if (m_opened)
	{
		m_opened = false;
...
void FEditorUI::Panels::PanelWindow::Focus()
{
	ImGui::SetWindowFocus((name + m_panelID).c_str());
}

void FEditorUI::Panels::PanelWindow::SetOpened(bool p_value)
{
	if (p_value != m_opened)
	{
		m_opened = p_value;
...
bool FEditorUI::Panels::PanelWindow::IsOpened() const
{
	return m_opened;
}

bool FEditorUI::Panels::PanelWindow::IsHovered() const
{
	return m_hovered;
}

bool FEditorUI::Panels::PanelWindow::IsFocused() const
{
	return m_focused;
}

bool FEditorUI::Panels::PanelWindow::IsAppearing() const
{
...
void FEditorUI::Panels::PanelWindow::ScrollToBottom()
{
    m_mustScrollToBottom = true;
}

void FEditorUI::Panels::PanelWindow::ScrollToTop()
{
    m_mustScrollToTop = true;
}

bool FEditorUI::Panels::PanelWindow::IsScrolledToBottom() const
{
    return m_scrolledToBottom;
}

bool FEditorUI::Panels::PanelWindow::IsScrolledToTop() const
{
    return m_scrolledToTop;
}

void FEditorUI::Panels::PanelWindow::_Draw_Impl()
{
	if (m_opened)
	{
