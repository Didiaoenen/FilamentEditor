...
void FEditorUI::Modules::Canvas::Draw()
{
	if (!m_panels.empty())
	{
...
void FEditorUI::Modules::Canvas::AddPanel(Panels::APanel & p_panel)
{
	m_panels.push_back(std::ref(p_panel));
}

void FEditorUI::Modules::Canvas::RemovePanel(Panels::APanel & p_panel)
{
...
void FEditorUI::Modules::Canvas::RemoveAllPanels()
{
	m_panels.clear();
}

void FEditorUI::Modules::Canvas::MakeDockspace(bool p_state)
{
	m_isDockspace = p_state;
}

bool FEditorUI::Modules::Canvas::IsDockspace() const
{
