...
#include "FEditorUI/Internal/EMemoryMode.h"
...
namespace FEditorUI::Internal
{
	...
	*/
	...
	public:
		...
		*/
		std::vector<std::pair<FEditorUI::Widgets::AWidget*, Internal::EMemoryMode>>& GetWidgets();

	protected:
		std::vector<std::pair<FEditorUI::Widgets::AWidget*, Internal::EMemoryMode>> m_widgets;
