...
FWindow::Dialogs::FileDialog::FileDialog(std::function<int(tagOFNA*)> p_callback, const std::string & p_dialogTitle) :
...
void FWindow::Dialogs::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
	m_initialDirectory = p_initialDirectory;
}

void FWindow::Dialogs::FileDialog::Show(EExplorerFlags p_flags)
{
	OPENFILENAME ofn;
...
bool FWindow::Dialogs::FileDialog::HasSucceeded() const
{
	return m_succeeded;
}

std::string FWindow::Dialogs::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string FWindow::Dialogs::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string FWindow::Dialogs::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool FWindow::Dialogs::FileDialog::IsFileExisting() const
{
	return std::filesystem::exists(m_filepath);
}

void FWindow::Dialogs::FileDialog::HandleError()
{
