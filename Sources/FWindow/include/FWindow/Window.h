...
#include "FWindow/Settings/WindowSettings.h"
#include "FWindow/Cursor/ECursorShape.h"
#include "FWindow/Cursor/ECursorMode.h"
...
namespace FWindow
{
	...
	*/
	...
	public:
		/* Inputs relatives */
		FTools::Eventing::Event<int> KeyPressedEvent;
		FTools::Eventing::Event<int> KeyReleasedEvent;
		FTools::Eventing::Event<int> MouseButtonPressedEvent;
		FTools::Eventing::Event<int> MouseButtonReleasedEvent;

		/* Window events */
		FTools::Eventing::Event<uint16_t, uint16_t> ResizeEvent;
		FTools::Eventing::Event<uint16_t, uint16_t> FramebufferResizeEvent;
		FTools::Eventing::Event<int16_t, int16_t> MoveEvent;
		FTools::Eventing::Event<int16_t, int16_t> CursorMoveEvent;
		FTools::Eventing::Event<> MinimizeEvent;
		FTools::Eventing::Event<> MaximizeEvent;
		FTools::Eventing::Event<> GainFocusEvent;
		FTools::Eventing::Event<> LostFocusEvent;
