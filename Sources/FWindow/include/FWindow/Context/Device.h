...
#include "FWindow/Context/EDeviceError.h"
#include "FWindow/Settings/DeviceSettings.h"
#include "FWindow/Cursor/ECursorShape.h"

namespace FWindow::Context
{
	/**
	...
	*/
	...
	public:
		...
		*/
		static FTools::Eventing::Event<EDeviceError, std::string> ErrorEvent;
